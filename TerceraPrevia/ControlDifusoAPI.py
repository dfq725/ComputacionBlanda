...
# Se crean los objetos antecedentes y consecuente a partir de las variables
# del universo y las funciones de membresia
...
# Las funciones de membresia personalizadas se pueden construir interactivamente
# con la API Pythonic
...
print(asignacion_propina.output['poropina'])
